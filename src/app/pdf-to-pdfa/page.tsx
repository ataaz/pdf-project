    ...
    <div className="container mx-auto p-4 md:p-8 max-w-6xl">
      <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-3">
          <FileArchive className="h-8 w-8 sm:h-10 sm:w-10 text-primary" />
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-primary">PDF to PDF/A</h1>
            <p className="text-base sm:text-lg text-muted-foreground">Convert PDF to PDF/A for long-term archiving</p>
          </div>
        </div>
      </header>
